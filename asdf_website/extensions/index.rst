...
In addition to the core schemas defined in the ASDF Specification, there are several additional schemas available as extensions. These schemas are based upon the schemas in :ref:`ASDF Specification <asdf-standard:asdf-standard>` and are packaged for use by the :ref:`asdf <asdf:asdf>` library.
